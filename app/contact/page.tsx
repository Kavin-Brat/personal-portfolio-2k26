        ...
        <div className="grid md:grid-cols-12 gap-12 items-start">
          ...
          <div className="md:col-span-5 space-y-4">
            ...
            <div className="p-4 rounded-xl border border-slate-200/30 dark:border-slate-800/40 bg-slate-50/20 dark:bg-slate-900/5 flex items-center gap-4 hover:border-amber-500/40 transition-colors">
              <div className="p-3 bg-amber-500/10 text-amber-505 rounded-lg text-amber-500">
                <EmailIcon />
              </div>
              <div>
            ...
            {/* GitHub Item */}
            <div className="p-4 rounded-xl border border-slate-200/30 dark:border-slate-800/40 bg-slate-50/20 dark:bg-slate-900/5 flex items-center gap-4 hover:border-amber-500/40 transition-colors">
              <div className="p-3 bg-slate-900/10 dark:bg-white/10 text-slate-700 dark:text-slate-350 rounded-lg">
                <GitHubIcon />
              </div>
              <div>
                <h4 className="text-xs font-semibold text-slate-500 dark:text-slate-450 uppercase">GitHub</h4>
                <a href={SOCIAL_LINKS.github} target="_blank" rel="noreferrer" className="text-sm sm:text-base font-bold text-slate-805 dark:text-slate-100 hover:text-amber-500">
            ...
            <div className="p-4 rounded-xl border border-slate-200/30 dark:border-slate-800/40 bg-slate-50/20 dark:bg-slate-900/5 flex items-center gap-4 hover:border-amber-500/40 transition-colors">
              ...
              <div>
                <h4 className="text-xs font-semibold text-slate-500 dark:text-slate-450 uppercase">LinkedIn</h4>
                <a href={SOCIAL_LINKS.linkedin} target="_blank" rel="noreferrer" className="text-sm sm:text-base font-bold text-slate-805 dark:text-slate-100 hover:text-amber-500">
