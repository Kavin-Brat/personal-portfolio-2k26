...
export const ABOUT_CONTENT: AboutContent = {
  ...
  paragraphs: [
    "I am <strong>Kavin Barath</strong>, a <strong>Senior Full-Stack Engineer</strong> based in <strong>Bengaluru</strong> with <strong>5+ years of experience</strong> specializing in building and scaling enterprise-level applications using <strong>React.js</strong> and <strong>Node.js</strong>.",
    "Proven track record of leading development teams, collaborating across cross-functional units, and delivering customer-centric solutions with robust API integrations.",
